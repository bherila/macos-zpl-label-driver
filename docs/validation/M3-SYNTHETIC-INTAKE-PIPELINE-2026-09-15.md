...
**Scope:** native automated evidence at `5a34971`. This connects an already
...
- LabelMac — 132 passed in debug and release;
- focused descriptor/pipeline suite — 7 passed;
