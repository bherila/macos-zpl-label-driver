...
| [ ] | M2-AC12 | Performance baseline | I | Release-mode latency, peak memory, output bytes and throughput are recorded on a named reference Mac with reproducible fixtures. |
