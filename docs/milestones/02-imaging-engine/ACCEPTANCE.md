...
| [x] | M2-AC04 | One-bit layout | A | MSB-first top-down 1=black layout, stride and white tail bits pass adversarial widths including 1,7,8,9,811,812,813 dots. Evidence: [2026-09-19 re-seal after manifest scope](../../validation/M2-RESEAL-AFTER-MANIFEST-SCOPE-2026-09-19.md). |
