...
| [x] | M4-AC03 | Multiple labels/order | A | Multi-region/multipage extraction and collated/uncollated copies match the shared ordering examples exactly. Evidence: [2026-09-15 canonical draft, ordering, and page accounting](../../validation/M4-DRAFT-ORDER-ACCOUNTING-2026-09-15.md). |
...
| [x] | M4-AC05 | Non-label pages | A | Every source page is accounted for; customs/instructions are not silently dropped and explicit skips are reported. Evidence: [2026-09-15 canonical draft, ordering, and page accounting](../../validation/M4-DRAFT-ORDER-ACCOUNTING-2026-09-15.md). |
