...
| [x] | M3-AC02 | Settings validation | A | Every explicit choice is range/combination checked; unsupported options fail instead of silently clamping or dropping. Evidence: [current per-ID assessment](../../validation/M3-SETTINGS-VALIDATION-ASSESSMENT-2026-09-17.md); [historical controls](../../validation/M3-AUTOMATED-CONTROLS-2026-09-15.md). |
| [x] | M3-AC03 | Control coverage | A | Protocol mapping covers speed, darkness, thermal method, tracking, dimensions, offsets and supported finishing with cited semantics. Evidence: [source-bound automated assessment](../../validation/M3-CONTROL-COVERAGE-ASSESSMENT-2026-09-17.md). |
...
| [x] | M3-AC05 | Network correctness | A | Short writes, backpressure, framing, zero-byte failure, mid-stream disconnect and timeouts pass simulator tests. Evidence: [source-bound automated assessment](../../validation/M3-NETWORK-CORRECTNESS-ASSESSMENT-2026-09-17.md). |
