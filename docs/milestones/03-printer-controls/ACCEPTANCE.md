...
| [x] | M3-AC03 | Control coverage | A | Protocol mapping covers speed, darkness, thermal method, tracking, dimensions, offsets and supported finishing with cited semantics. |
